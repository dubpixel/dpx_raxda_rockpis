...
### Added
- Initial release — custom two-part POE enclosure for Radxa Rock Pi S + POE HAT v1.2
- STL files for top and bottom shells, design iterations v8 through v14
- `.3mf` assembly file for PrusaSlicer / Bambu Studio
- Official Radxa reference models in `src/reference/` (STEP/DWG) used as design basis
- README with print settings, usage instructions, and design iteration notes
